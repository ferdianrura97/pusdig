...
<body class="hold-transition login-page"
    style="background-image: url('{{ asset('balai.jpg')}}'); background-repeat: no-repeat;background-size: cover">
    <div class="login-box">
        <div class="card">
            <div class="card-body login-card-body">
                <center><img src="{{ asset('logo.png') }}" width="50%" alt=""></center>
                <hr>
                    ...
                    <div class="input-group mb-3">
                       <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                        ...
                        <span class="invalid-feedback" role="alert">
                            <strong>E-mail atau Password Salah</strong>
                        </span>
                        @enderror
